  ...
  var education = [
    {
      ...
      couse: "Higher Secondary Course",
      year: { start: 2021, end: 2023 },
    },
    {
      CollegeName: "Arka Jain University , Jamshedpur",
      couse: "Bachelor Of Computer Application",
      ...
      <div className="mt-20 w-full  mb-10 px-5 sm:px-0">
        <div className="">
          {education.map((elem, index) => (
            ...
            >
              <div className="mt-10 h-full w-full sm:w-[40%] lg:w-[30%] bg-[##390F7C] flex flex-col items-center justify-center rounded-lg shadow-[0px_0px_15px_rgba(255,255,255,1)] hover:scale-105 duration-300 py-[10vh] text-[#00EEFF] ">
                <h1 className="text-xl font-semibold text-center">{elem.CollegeName}</h1>
                <h1 className="text-xl font-semibold text-center">
                  {elem.couse}
                </h1>
              </div>

              <span className="inline-block sm:mt-[7vh] lg:mt-[10vh]  ml-[19vh] mt-10 sm:ml-10 h-[10vh] w-[1px] sm:h-[1px] sm:w-[10vw] bg-white rounded-full"></span>
