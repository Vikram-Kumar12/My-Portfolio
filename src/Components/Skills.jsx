...
function Skills() {
...

    {
      ...
      icon: (
        <svg
          ...
          height="2em"
        >
          <circle cx="64" cy="64" r="64" fill="#00EEFF" />
          <g fill="#FFFFFF">
            <path d="M89.2 32.1c-9.9-5.7-22.6-5.6-33.2 0-1.3.7-1.7 2.2-1.2 3.6.6 1.4 2 2.2 3.4 1.9 8.6-3.2 18.7-3.3 27.2 0 1.4.5 2.8-.5 3.3-1.9.6-1.4.1-2.8-1.3-3.6zM41.7 73.3c-8.7 5.4-13.4 14.3-13.1 24.2.1 1.7 1.5 3 3.2 3.1h63.1c1.7 0 3.1-1.3 3.2-3-.1-9.9-4.8-18.8-13.5-24.3-1.3-.8-2.9-.3-3.7 1-.8 1.3-.3 2.9 1 3.7 6.7 4.1 10.6 11 10.9 19H34.4c.2-8.1 4-15 10.7-19.2 1.3-.8 1.8-2.4 1-3.7-.7-1.3-2.4-1.7-3.7-.9z" />
          </g>
        </svg>
      ),
      percentage: 50,
    },
    {
      ...
      icon: (
        <svg
          ...
          height="2em"
        >
          <circle cx="64" cy="64" r="62" fill="#00EEFF" />
          <g fill="#FFFFFF">
  ...
  return (
    <div className="sm:flex gap-6 py-20">
      
      <div className="w-full">
        <h1 className="ml-10 text-5xl text-[#00EEFF] mb-10">Programming</h1>
        <div className="w-full px-4 sm:px-10">
          {programing.map((skill, index) => (
            <div key={index} className="w-full mb-5">
              ...
              <h1 className="mr-4">{skill.percentage}</h1>
              </div>
      ...
      <div className="w-full mt-20 sm:mt-0">
        <h1 className="text-center text-4xl sm:text-5xl text-[#00EEFF] mb-10">Framework & Tools</h1>
        <div className=" w-full  px-4 sm:px-10">
          {frameworks.map((framework, index) => (
            <div key={index} className="w-full mb-5">
              ...
              <div className="flex gap-5 items-center ">
              {framework.icon}
              <span className=" text-cyan-300">{framework.Name}</span>
              </div>
              <h1 className="mr-4">{framework.percentage}</h1>
              </div>
